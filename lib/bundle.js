...
class Game {
  ...
  addPellets() {
    ...
    for (let i = 0; i < Game.NUM_PELLETS; i++) {
      ...
      pellets.push(new __WEBPACK_IMPORTED_MODULE_2__pellet__["a" /* default */](pos));
    }
    return pellets;
  }
...
class GameView {
  ...
  wrap(pos) {
    return [
      __WEBPACK_IMPORTED_MODULE_0__util__["a" /* default */].wrap(pos[0], window.WIDTH), this.util.wrap(pos[1], window.HEIGHT)
    ];
  }
...
class MovingMorays {
  ...
  //velocity of object is how far it should move in 1/60th of a second
    ...
    let offsetX = this.velX * 2;
    let offsetY = this.velY * 2;
